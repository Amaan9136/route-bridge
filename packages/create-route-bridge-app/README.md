...
- **v0.0.2: Maintenance and Example Fixes** — updated Express + Next.js and Flask + Next.js demos to support custom inputs and clearer flows
- **feat: updated the frontend examples to give custom inputs** — refreshed both frontend demos so you can pass your own values and see typed responses end-to-end
